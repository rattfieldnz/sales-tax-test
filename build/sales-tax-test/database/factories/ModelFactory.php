...
$factory->define(
    App\Models\Basket::class, function (Faker\Generator $faker) {
        return [
        'receipt_id' => function () {
...
$factory->define(
    App\Models\Product::class, function (Faker\Generator $faker) {
        return [
...
$factory->define(
    App\Models\Receipt::class, function (Faker\Generator $faker) {
        return [
